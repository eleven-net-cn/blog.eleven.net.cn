...
最后，这里（ ☞ [传送门](https://github.com/eleven-net-cn/create-react-app/blob/master/packages/cra-template-typescript/template/craco.config.js) ）有一份完整的 craco.config.js 配置文件，方便参照。
